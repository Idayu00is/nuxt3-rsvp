...
import { escapeHtml } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/ofetch/dist/node.mjs';
...
import { getContext } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/source-map/source-map.js';
...
import { walkResolver } from 'file:///Users/rosmaidayubintiismail/wedding-invite/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/rosmaidayubintiismail/wedding-invite/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/rosmaidayubintiismail/wedding-invite","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/rosmaidayubintiismail/wedding-invite/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/rosmaidayubintiismail/wedding-invite/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/rosmaidayubintiismail/wedding-invite/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/rosmaidayubintiismail/wedding-invite/.data/kv"}));
...
const _g6hJwMiigj9TWDyJ1oMvPItlp5sUth9sb8nFtaiAY = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/rosmaidayubintiismail/wedding-invite";
...
const _HEY2j0mmV4_EluiVuO0Z5QenKrIQtuppWFJETIDqYkA = (nitroApp) => {
...
const getServerEntry = () => import('file:///Users/rosmaidayubintiismail/wedding-invite/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/rosmaidayubintiismail/wedding-invite/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_Ba_mtC = () => Promise.resolve().then(function () { return renderer$1; });
